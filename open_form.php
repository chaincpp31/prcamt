            ...
            <form method="post" action="insert.php" >
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio font-db-adman-x">
                        <input class="custom-control-input" type="radio" name="position" value="student" required="" id="type_0" checked <?php if (isset($position) && $position=="teacher") echo "checked";?>>
                ...
                <div class="form-group">
                    <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12 border">
                                <div class="form-group">
                                    <h3>เลือกสาขาที่ต้องการเข้าร่วมกิจกรรม workshop</h3>
                                    <p>*สามารถเข้าร่วมกิจกรรมสาขาได้ทั้ง 2 ช่วงเวลาหรือช่วงใดช่วงหนึ่ง</p>
                                <p class="text-bold mt-2 mb-0"><h5>เข้าร่วมกิจกรรม workshop ช่วงเช้า 9.00 - 11.00 น.</h5><sup class="text-danger">*</sup></p>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="0" type="radio" name="morning" value="ani" required="" id="morning_0" >
                                    <label class="custom-control-label" for="morning_0">Animation</label>
                                    </div>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="1" type="radio" name="morning" value="dg" required="" id="morning_1" >
                                    <label class="custom-control-label" for="morning_1">Digital Game</label>
                                    </div>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="2" type="radio" name="morning" value="mmit" required="" id="morning_2" >
                                    <label class="custom-control-label" for="morning_2">Modern Management Information Technology</label>
                                    </div>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="3" type="radio" name="morning" value="dii" required="" id="morning_3" >
                                    <label class="custom-control-label" for="morning_3">Digital Industry Intigration</label>
                                    </div>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="4" type="radio" name="morning" value="se" required="" id="morning_4" >
                                    <label class="custom-control-label" for="morning_4">Software Engineer</label>
                                    </div> 
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="10" type="radio" name="morning" value="no visit" required="" id="morning_10" >
                                    <label class="custom-control-label" for="morning_10">ไม่เข้าร่วม</label>
                                    
                                    </div>  
                                    <p class="text-bold mt-2 mb-0"><h5>เข้าร่วมกิจกรรม workshop ช่วงบ่าย 13.00 - 15.00 น.</h5><sup class="text-danger">*</sup></p>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="5" type="radio" name="affternoon" value="ani" required="" id="affternoon_0" >
                                    <label class="custom-control-label" for="affternoon_0">Animation</label>
                                    </div>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="6" type="radio" name="affternoon" value="dg" required="" id="affternoon_1" >
                                    <label class="custom-control-label" for="affternoon_1">Digital Game</label>
                                    </div>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="7" type="radio" name="affternoon" value="mmit" required="" id="affternoon_2" >
                                    <label class="custom-control-label" for="affternoon_2">Modern Management Information Technology</label>
                                    </div>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="8" type="radio" name="affternoon" value="dii" required="" id="affternoon_3" >
                                    <label class="custom-control-label" for="affternoon_3">Digital Industry Intigration</label>
                                    </div>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="4" type="radio" name="affternoon" value="se" required="" id="affternoon_4" >
                                    <label class="custom-control-label" for="affternoon_4">Software Engineer</label>
                                    </div>
                                    <div class="custom-control custom-radio font-db-adman-x">
                                    <input class="custom-control-input" data-type="9" type="radio" name="affternoon" value="no visit" required="" id="affternoon_9" >
                                    <label class="custom-control-label" for="affternoon_9">ไม่เข้าร่วม</label>
                                    </div>    
                        </div>
