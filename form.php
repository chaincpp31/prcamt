          ...
          <div class="row">
              <div class="col-lg-8 col-md-8">
                <ul class="top-info text-center text-md-left">
                    <li><i class="fas fa-map-marker-alt"></i> <p class="info-text">239 ถนนห้วยแก้ว ตำบลสุเทพ อำเภอเมือง จังหวัดเชียงใหม่</p>
                    </li>
                </ul>
              </div>
              <!--/ Top info end -->
...
<section id="ts-features" class="ts-features">
  <div class="container">
    <div class="row">
        ...
        <h3>CAMT OPENHOUSE OPENHEART 2022</h3>
        <div class="w3-row-padding" style="margin:0 -16px;">
            <div class="w3-half">
            <label>ชื่อ-นามสกุล</label>
            <input name="name" class="w3-input w3-border" type="text" placeholder="ชื่อ-นามสกุล" require>
            <label>ชั้นมัธยมศึกษา</label>
            <input name="degree" class="w3-input w3-border" type="text" placeholder="ปีที่">
            ...
            <lable>email</lable>
            <input name="email" class="w3-input w3-border" type="email" placeholder="email">
